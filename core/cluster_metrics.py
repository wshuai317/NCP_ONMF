...
def visualize_data(data_arr = None, dat_embeded = None, dim = 2, partition_idx = None, dat_path = None, \
        xlabel = '', ylabel = '', title = ''):
    ...
    if data_arr is None or dat_embeded is None:
	raise ValueError('Error: no input data for visulization!')
