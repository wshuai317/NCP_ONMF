...
class SNCP2C_Solver(object):
	...
	res_dir1 = path.join(res_dir, 'sncp2c', self.data_manager.get_data_name(), 'cls' + str(rank), W_bound, \
	...
	data_kind, data_num = self.data_manager.data_kind, self.data_manager.data_num
	if data_kind.startswith('syn'):
	    self.H_step = 0.51
    ...
    def update_scheme(self):
        ...
        '''
        # update 
	(self.W, self.H, inner_iter_num) = self.update_prim_var_by_PALM(self.W, self.H, 1000, self.inner_tol, verbose = True)
